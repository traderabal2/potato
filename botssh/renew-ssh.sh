...
data_ip="https://raw.githubusercontent.com/HendraVPN/Register/main/register"
checking_sc() {
  ...
  if [[ $date_list < $useexp ]]; then
    ...
    echo -e "      \033[0;36mTelegram${NC} t.me/hendravpn"
    echo -e "      ${GREEN}WhatsApp${NC} wa.me/6282184684197"
    echo -e "\033[1;93m────────────────────────────────────────────\033[0m"
    exit
  fi
}
