...
TIMES="10"
CHATID="870239854"
KEY="7586521967:AAH60LBngEAG__WdS7-VGaQu7K-IBvC5gyM"
...
clear;clear;clear
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "\033[96;1m               AUTOSCRIPT SFVpn STORE            \033[0m"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 3
clear
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://t.me/SFvpn"},{"text":"Contack","url":"https://wa.me/62816384682"}]]}'
...
wget raw.githubusercontent.com/traderabal2/potato/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
cd
